...
},{"./dynamicTabsDemo":2,"./fancyDemo":3,"./statefulDemo":4,"./statelessDemo":5}],2:[function(require,module,exports){
'use strict';
...
var tabTitles = ['I am a tab', 'Tabs are Cool!', 'New Tab Here', 'Just Another Tab', 'Doing Tab Things'];
...
var DynamicTabsDemo = function (_React$Component) {
  _inherits(DynamicTabsDemo, _React$Component);

  function DynamicTabsDemo(props) {
    _classCallCheck(this, DynamicTabsDemo);

    var _this = _possibleConstructorReturn(this, (DynamicTabsDemo.__proto__ || Object.getPrototypeOf(DynamicTabsDemo)).call(this, props));
  ...
  _createClass(DynamicTabsDemo, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          tabDescriptions = _state.tabDescriptions;

      var tabs = tabDescriptions.map(function (tabDescription) {
        return _this2.renderTab(tabDescription);
      });
      var panels = tabDescriptions.map(function (tabDescription) {
        return _this2.renderTabContent(tabDescription);
      });
      var hasMultipleTabs = tabDescriptions.length > 1;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'ul',
              { className: 'Tabs-tablist Tabs-dynamic-tablist' },
              tabs
            )
          ),
          _react2.default.createElement(
    ...
    key: 'renderTab',
    value: function renderTab(tabDescription) {
      ...
      return _react2.default.createElement(
        'li',
        { className: 'Tabs-tablistItem', key: tabDescription.id },
        _react2.default.createElement(
          _2.default.Tab,
          {
    ...
    value: function renderTabContent(tabDescription) {
      var activeTab = this.state.activeTab;
    ...
    key: 'handleAddNewTabClick',
    value: function handleAddNewTabClick() {
      var tabDescriptions = this.state.tabDescriptions;

      var tabsData = tabDescriptions.slice();
      var tabId = uniqueId();
      var newTab = {
    ...
    key: 'handleRemoveRandomTabClick',
    value: function handleRemoveRandomTabClick() {
      var _state2 = this.state,
          tabDescriptions = _state2.tabDescriptions,
          activeTab = _state2.activeTab;

      var newState = {};
      var tabsData = tabDescriptions.slice();
      var tabToRemoveIdx = Math.floor(Math.random() * tabDescriptions.length);
      var tabToRemove = tabDescriptions[tabToRemoveIdx];
      var isActiveTab = tabToRemove.id === activeTab;
      var nextActiveTabId = tabDescriptions[tabToRemoveIdx === 0 ? 1 : tabToRemoveIdx - 1].id;
    ...
    key: 'handleChangeActiveTabClick',
    value: function handleChangeActiveTabClick() {
      var _state3 = this.state,
          tabDescriptions = _state3.tabDescriptions,
          activeTab = _state3.activeTab;

      var activeTabIdx = tabDescriptions.findIndex(function (tabDescription) {
        return tabDescription.id === activeTab;
      });
      var newActiveTabIdx = Math.floor(Math.random() * tabDescriptions.length);
      ...
      var newActiveTabId = tabDescriptions[newActiveTabIdx].id;
    ...
    key: 'generateTabContent',
    value: function generateTabContent() {
      return tabsData[Math.floor(Math.random() * tabsData.length)].content;
    }
  }, {
    key: 'generateTabTitle',
    value: function generateTabTitle() {
      return tabTitles[Math.floor(Math.random() * tabTitles.length)];
    }
  }]);

  return DynamicTabsDemo;
}(_react2.default.Component);

_reactDom2.default.render(_react2.default.createElement(DynamicTabsDemo, null), document.getElementById('dynamic-tabs-demo'));

},{"../..":6,"react":42,"react-dom":39}],3:[function(require,module,exports){
'use strict';
...
},{"../..":6,"react":42,"react-dom":39}],4:[function(require,module,exports){
'use strict';
...
},{"../..":6,"react":42,"react-dom":39}],5:[function(require,module,exports){
'use strict';
...
},{"../..":6,"react":42,"react-dom":39}],6:[function(require,module,exports){
'use strict';
...
},{"./lib/Tab":7,"./lib/TabList":8,"./lib/TabPanel":9,"./lib/Wrapper":10}],7:[function(require,module,exports){
'use strict';
...
},{"./specialAssign":12,"create-react-class":14,"prop-types":35,"react":42}],8:[function(require,module,exports){
'use strict';
...
},{"./specialAssign":12,"create-react-class":14,"prop-types":35,"react":42}],9:[function(require,module,exports){
'use strict';
...
},{"./specialAssign":12,"create-react-class":14,"prop-types":35,"react":42}],10:[function(require,module,exports){
'use strict';
...
},{"./createManager":11,"./specialAssign":12,"create-react-class":14,"prop-types":35,"react":42}],11:[function(require,module,exports){
'use strict';
...
},{"focus-group":29}],12:[function(require,module,exports){
"use strict";
...
},{"_process":31,"fbjs/lib/emptyObject":20,"fbjs/lib/invariant":24,"fbjs/lib/warning":28,"object-assign":30}],14:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factory":13,"react":42}],15:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./lib/ReactPropTypesSecret":36,"_process":31,"fbjs/lib/invariant":24,"fbjs/lib/warning":28}],33:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./lib/ReactPropTypesSecret":36,"fbjs/lib/emptyFunction":19,"fbjs/lib/invariant":24}],34:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./checkPropTypes":32,"./lib/ReactPropTypesSecret":36,"_process":31,"fbjs/lib/emptyFunction":19,"fbjs/lib/invariant":24,"fbjs/lib/warning":28,"object-assign":30}],35:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"fbjs/lib/ExecutionEnvironment":15,"fbjs/lib/containsNode":18,"fbjs/lib/emptyFunction":19,"fbjs/lib/emptyObject":20,"fbjs/lib/getActiveElement":21,"fbjs/lib/invariant":24,"fbjs/lib/shallowEqual":27,"object-assign":30,"react":42}],39:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":31,"fbjs/lib/emptyFunction":19,"fbjs/lib/emptyObject":20,"fbjs/lib/invariant":24,"fbjs/lib/warning":28,"object-assign":30,"prop-types/checkPropTypes":32}],41:[function(require,module,exports){
/** @license React v16.3.2
...
},{"fbjs/lib/emptyFunction":19,"fbjs/lib/emptyObject":20,"fbjs/lib/invariant":24,"object-assign":30}],42:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":40,"./cjs/react.production.min.js":41,"_process":31}]},{},[1]);
